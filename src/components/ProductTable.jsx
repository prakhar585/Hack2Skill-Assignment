      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-1  desktop:px-6 desktop:py-3 text-center text-xs font-medium text-gray-500 uppercase">
                ID
              </th>
              <th className="px-1  desktop:px-6 desktop:py-3 text-center text-xs font-medium text-gray-500 uppercase">
                Product
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {tableData.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                ...
                {/* <td className="mx-auto px-1 py-3 desktop:px-6 desktop:py-4 h-full">
